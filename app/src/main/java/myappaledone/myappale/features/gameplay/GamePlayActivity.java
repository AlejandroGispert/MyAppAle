...
import myappaledone.myappale.features.SoundPlayer;
...
import myappaledone.myappale.custom.LetterBoard;
import myappaledone.myappale.custom.StreakView;
import myappaledone.myappale.custom.layout.FlowLayout;
...
public class GamePlayActivity extends FullscreenActivity {
    ...
    public static final String EXTRA_GAME_ROUND_ID =
            "myappaledone.myappale.features.gameplay.GamePlayActivity.ID";
    public static final String EXTRA_ROW_COUNT =
            "myappaledone.myappale.features.gameplay.GamePlayActivity.ROW";
    public static final String EXTRA_COL_COUNT =
            "myappaledone.myappale.features.gameplay.GamePlayActivity.COL";
